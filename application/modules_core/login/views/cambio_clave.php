...
<div class="col-md-4">
	<form class="form-signin" method="post" action="<?php echo $form_action; ?>">
		...
		<input type="password" name="old_pass" class="form-control" placeholder="Clave Antigua">
		<input type="password" name="new_pass" class="form-control" placeholder="Clave Nueva">
		<input type="password" name="new_pass" class="form-control" placeholder="Clave Nueva">
