...
<?php if ( isset($show_add) && $show_add): ?>
	<a href="<?php echo site_url('productos/add');?>">
		<img class="list" src="<?php echo ASSETS . 'frontend/images/icons/add.png'; ?>" alt="listar" title="Agregar Remitos" width="85" height="85" />
	</a>
<?php endif; ?>

<?php if ( isset($show_list) && $show_list ): ?>
	<a href="<?php echo site_url('productos/listar');?>">
		<img class="list" src="<?php echo ASSETS . 'frontend/images/icons/list.png'; ?>" alt="listar" title="Listar Remitos" width="85" height="85" />
	</a>
<?php endif;?>
